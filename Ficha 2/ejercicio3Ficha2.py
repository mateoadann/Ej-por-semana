...
# La famosa ecuación de Einstein para conversión de una masa m en energía viene dada por la fórmula:  E = mc2
...
# Dates
print( ' no se como hacerlo, vamos a preguntar después como lo hago... ')
