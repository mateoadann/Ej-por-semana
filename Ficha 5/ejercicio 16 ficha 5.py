...
# Realizar un programa que permita calcular las raíces de un polinomio de segundo grado
# y mostrar un mensaje indicando si son reales o imaginarias. Si son reales distintas, mostrar sus dos valores,
# si son reales iguales, mostrar solo una.
#
# Ayudita: A partir del discriminante Δ, es posible determinar la naturaleza de las raíces de la ecuación
