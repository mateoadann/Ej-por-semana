...
# (esto es: el 1, el 3 y el 5) (y de allí el nombre del juego). El puntaje de la tirada se calcula sumando el aporte de cada dado,
...
# Se pide: que en base a toodo lo indicado, se genere un programa que simule 1 tirada de los 3 dados
#  y luego habiendo solicitado al usuario que cargue su puntaje previo,
#  informe su puntaje acumulado en el caso de haber obtenido puntos, su puntaje previo
#  y el mensaje de que duplica puntos si salieron los 3 pares o simplemente su puntaje previo si no sumó ningún punto.
