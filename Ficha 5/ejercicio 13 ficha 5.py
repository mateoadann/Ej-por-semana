...
# Por cada postulante se tiene la siguiente información: nombre del postulante,
...
# e indique finalmente el nombre del postulante que ganó el puesto. Los criterios de aprobación son los siguientes,
# en función del porcentaje de respuestas correctas sobre el total de preguntas realizadas a cada postulante:
#
